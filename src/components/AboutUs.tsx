    ...
    <div className="max-w-7xl mx-auto px-4 py-12 space-y-12">
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          >
            Your premier destination for booking sports turfs with ease. We're
            passionate about making sports accessible to everyone.
          </motion.p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-4 text-gray-600">
          <p>
            TurfBook was founded with a simple vision: to make sports facilities
            accessible to everyone. We understand the struggle of finding and
            booking quality turfs for your favorite sports.
          </p>
          <p>
            Our platform connects sports enthusiasts with premium turf
            facilities across the city. Whether you're planning a friendly
            football match, a cricket game, or a swimming session, we've got you
            covered.
          </p>
          <p>
            With instant booking confirmations, flexible time slots, and
            competitive pricing, we're revolutionizing the way people book
            sports facilities. Join thousands of happy customers who trust
            TurfBook for their sporting needs.
          </p>
        </div>
      </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              ...
              {/* Decorative gradient */}
              <div
                className={`absolute -bottom-10 -right-10 w-32 h-32 bg-gradient-to-br ${feature.color} opacity-10 rounded-full blur-2xl`}
              ></div>
            </motion.div>
          ))}
        </div>
