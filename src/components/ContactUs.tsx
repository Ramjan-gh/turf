    ...
    <div className="max-w-7xl mx-auto px-4 py-12 space-y-12">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {contactInfo.map((info, index) => (
          ...
          >
            <div
              className={`w-14 h-14 bg-gradient-to-br ${info.color} rounded-xl flex items-center justify-center mb-4 shadow-lg mx-auto`}
            >
        ...
        >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white/80">
                  123 Sports Avenue, Gulshan-2, Dhaka-1212, Bangladesh
                </p>
              </div>
            </div>
          ...
          <div className="mt-8 p-6 bg-white/10 backdrop-blur-sm rounded-2xl">
            <p className="text-sm text-white/90">
              <strong>Note:</strong> For urgent booking inquiries, please call
              us directly. Our support team is available during business hours
              to assist you.
            </p>
          </div>
        </motion.div>
