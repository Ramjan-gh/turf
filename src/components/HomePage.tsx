...
import { Calendar, ChevronLeft, ChevronRight, Sparkles, TrendingUp, Zap } from 'lucide-react';
...
const SPORTS: Sport[] = [
  { 
    ...
    image: 'https://images.unsplash.com/photo-1713815713124-362af0201f3c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmb290YmFsbCUyMHR1cmYlMjBmaWVsZHxlbnwxfHx8fDE3NjMxODcxMzF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'
  },
  { 
    id: 'cricket', 
    name: 'Cricket', 
    ...
    image: 'https://images.unsplash.com/photo-1512719994953-eabf50895df7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjcmlja2V0JTIwc3RhZGl1bXxlbnwxfHx8fDE3NjMyMjIyMzV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'
  },
  { 
    id: 'swimming', 
    name: 'Swimming', 
    ...
    image: 'https://images.unsplash.com/photo-1558617320-e695f0d420de?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzd2ltbWluZyUyMHBvb2x8ZW58MXx8fHwxNzYzMjM1NzQ2fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'
  },
];
  ...
  <div className="relative z-10">
    ...
    >
      ...
      >
        ...
        <div className="bg-[#E0ECDE] rounded-2xl border border-gray-200 p-5 shadow-lg">
          <div className="flex items-center justify-between gap-4">
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <Button
                ...
                className="flex-shrink-0 rounded-full hover:bg-green-50"
              >
            ...
            {[0, 1, 2, 3, 4, 5, 6].map((offset) => {
              ...
              return (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`flex-shrink-0 p-4 rounded-2xl transition-all min-w-[80px] shadow-md ${
                    isSelected
                      ? 'bg-gradient-to-br from-green-500 to-emerald-600 text-white'
                      : 'bg-gradient-to-br from-gray-50 to-gray-100 text-gray-900 hover:from-green-50 hover:to-emerald-50'
                  }`}
                >
                  <div className={`text-xs mb-1 ${isSelected ? 'text-green-100' : 'text-gray-500'}`}>
                    {format(date, 'EEE')}
                  </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className={`text-xs ${booked ? 'text-gray-500' : 'text-green-100'}`}>
                    {booked ? 'Booked' : `৳${selectedSportData?.pricePerHour}`}
                  </div>
                </div>
              </motion.button>
            );
